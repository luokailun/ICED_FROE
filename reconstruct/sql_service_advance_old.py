...
def read_config(json_file):
    ...
    try:
        with open(json_file, 'r') as input_stream:
            ...
            idName = data['split_tables'][0]['split_table_name']
...
test='''SELECT name, meeting_host, device_identifier, email FROM meeting100w WHERE meeting_host = '通霏' '''
...
#result = compose_result('./table_config_n3_100w.json', test, BasicExecutor)
# print("\n\n##---------------\n")
# #print(result)
# print("\n##---------------\n")
